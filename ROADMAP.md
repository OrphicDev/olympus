...
| 🦄 **Pegasus** | Gérer les WordPress clients depuis Claude Code | ✅ |
...
- **Design** : monochrome strict, boutons = texte lumineux animé, pas de cartes, sélection pleine largeur. Seule couleur = présence (vert/rouge). ✅
