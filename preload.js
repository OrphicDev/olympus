...
contextBridge.exposeInMainWorld("olympus", {
  ...
  argosOverview: (brandId, days) => ipcRenderer.invoke("argos:overview", brandId, days),
  argosInbox: (brandId) => ipcRenderer.invoke("argos:inbox", brandId),
  ...
  argosAds: (brandId) => ipcRenderer.invoke("argos:ads", brandId),
