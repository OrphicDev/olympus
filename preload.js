...
contextBridge.exposeInMainWorld("olympus", {
  ...
  appDoUpdate: () => ipcRenderer.invoke("app:doUpdate"),
  // Hermès (chat)
  ...
  // Argos — social media management
  argosState: () => ipcRenderer.invoke("argos:state"),
  argosBrandSave: (brand) => ipcRenderer.invoke("argos:brandSave", brand),
  argosBrandDelete: (id) => ipcRenderer.invoke("argos:brandDelete", id),
  argosOverview: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:overview", brandId, days, forceRefresh, peek),
  argosInbox: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:inbox", brandId, forceRefresh, peek),
  argosInboxReply: (brandId, convId, text) => ipcRenderer.invoke("argos:inboxReply", brandId, convId, text),
  ...
  argosAds: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:ads", brandId, forceRefresh, peek),
  argosAdsCampaigns: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:adsCampaigns", brandId, days, forceRefresh, peek),
  argosAdsKeywords: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:adsKeywords", brandId, days, forceRefresh, peek),
  argosAdsAudiences: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:adsAudiences", brandId, days, forceRefresh, peek),
  argosAdsGeo: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:adsGeo", brandId, forceRefresh, peek),
  argosAdsPlacements: (brandId, period, forceRefresh, peek) => ipcRenderer.invoke("argos:adsPlacements", brandId, period, forceRefresh, peek),
  argosAdsExclusions: (brandId) => ipcRenderer.invoke("argos:adsExclusions", brandId),
  aiHasKey: () => ipcRenderer.invoke("ai:hasKey"),
  aiSetKey: (key) => ipcRenderer.invoke("ai:setKey", key),
  aiDraftReply: (payload) => ipcRenderer.invoke("ai:draftReply", payload),
  aiChat: (payload) => ipcRenderer.invoke("ai:chat", payload),
  mediaRead: (name) => ipcRenderer.invoke("media:read", name),
  argosAdsManaged: (brandId) => ipcRenderer.invoke("argos:adsManaged", brandId),
  argosAdsPlacementAction: (brandId, action, spec) => ipcRenderer.invoke("argos:adsPlacementAction", brandId, action, spec),
  argosAudience: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:audience", brandId, forceRefresh, peek),
  ...
  argosPosts: (brandId) => ipcRenderer.invoke("argos:posts", brandId),
  ...
  argosGoogleResync: () => ipcRenderer.invoke("argos:googleResync"),
  argosWeb: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:web", brandId, days, forceRefresh, peek),
  argosSeo: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:seo", brandId, days, forceRefresh, peek),
  argosSeoIntel: (brandId, days, forceRefresh, peek) => ipcRenderer.invoke("argos:seoIntel", brandId, days, forceRefresh, peek),
  argosVitals: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:vitals", brandId, forceRefresh, peek),
  argosCrawl: (brandId, forceRefresh, peek) => ipcRenderer.invoke("argos:crawl", brandId, forceRefresh, peek),
  argosTrends: (brandId, keywords, location, forceRefresh, peek) => ipcRenderer.invoke("argos:trends", brandId, keywords, location, forceRefresh, peek),
  argosSnapshot: (brandId, period) => ipcRenderer.invoke("argos:snapshot", brandId, period),
  argosReportSave: (brandId, period, snapshot) => ipcRenderer.invoke("argos:reportSave", brandId, period, snapshot),
  argosReportGet: (brandId, period) => ipcRenderer.invoke("argos:reportGet", brandId, period),
  // Search Intelligence — fournisseur de données payant (DataForSEO), coûts, budget
  siStatus: () => ipcRenderer.invoke("si:status"),
  siSaveKeys: (login, password) => ipcRenderer.invoke("si:saveKeys", login, password),
  siTest: () => ipcRenderer.invoke("si:test"),
  siSetBudget: (soft, hard) => ipcRenderer.invoke("si:setBudget", soft, hard),
  siEstimate: (endpoint, count) => ipcRenderer.invoke("si:estimate", endpoint, count),
  siBudget: () => ipcRenderer.invoke("si:budget"),
  siSetSandbox: (on) => ipcRenderer.invoke("si:setSandbox", on),
  siSeoCompetitors: (brandId, peek) => ipcRenderer.invoke("si:seoCompetitors", brandId, peek),
  siContentGap: (brandId, competitor, peek) => ipcRenderer.invoke("si:contentGap", brandId, competitor, peek),
  siDomainOverview: (brandId, peek, domain) => ipcRenderer.invoke("si:domainOverview", brandId, peek, domain),
  siRankedKw: (brandId, peek) => ipcRenderer.invoke("si:rankedKw", brandId, peek),
  siCompetitorSea: (brandId, domain, peek) => ipcRenderer.invoke("si:competitorSea", brandId, domain, peek),
  siBacklinks: (brandId, peek) => ipcRenderer.invoke("si:backlinks", brandId, peek),
  siSea: (brandId, peek) => ipcRenderer.invoke("si:sea", brandId, peek),
  siSeaKwList: (brandId) => ipcRenderer.invoke("si:seaKwList", brandId),
  siSeaKwAdd: (brandId, kw) => ipcRenderer.invoke("si:seaKwAdd", brandId, kw),
  siSeaKwRemove: (brandId, kw) => ipcRenderer.invoke("si:seaKwRemove", brandId, kw),
  siSeaKwRefresh: (brandId, kw) => ipcRenderer.invoke("si:seaKwRefresh", brandId, kw),
  siSerp: (brandId, keyword, peek) => ipcRenderer.invoke("si:serp", brandId, keyword, peek),
  siKwMarket: (brandId, keywords, peek, location) => ipcRenderer.invoke("si:kwMarket", brandId, keywords, peek, location),
  siLocalCompetitors: (brandId, peek, depth) => ipcRenderer.invoke("si:localCompetitors", brandId, peek, depth),
  siLocalAges: (brandId, domains, peek) => ipcRenderer.invoke("si:localAges", brandId, domains, peek),
  siPlaceReviews: (brandId, placeId, peek) => ipcRenderer.invoke("si:placeReviews", brandId, placeId, peek),
  siKeywords: (brandId, peek) => ipcRenderer.invoke("si:keywords", brandId, peek),
  siPrewarmNow: (brandId) => ipcRenderer.invoke("si:prewarmNow", brandId),
  siPrewarmStatus: () => ipcRenderer.invoke("si:prewarmStatus"),
  siSetPrewarmAuto: (on) => ipcRenderer.invoke("si:setPrewarmAuto", on),
  siCloudSql: () => ipcRenderer.invoke("si:cloudSql"),
