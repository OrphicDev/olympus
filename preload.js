...
contextBridge.exposeInMainWorld("olympus", {
  ...
  argosOverview: (brandId, days, forceRefresh) => ipcRenderer.invoke("argos:overview", brandId, days, forceRefresh),
  argosInbox: (brandId, forceRefresh) => ipcRenderer.invoke("argos:inbox", brandId, forceRefresh),
